...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	launchReadinessHandler := admin.NewLaunchReadinessHandler(client, configConfig, settingService, paymentConfigService, channelService, opsService)
	...
	imageWorkbenchHandler := handler.NewImageWorkbenchHandler(apiKeyService, subscriptionService, settingService, channelService, openAIGatewayHandler)
	idempotencyCoordinator := service.ProvideIdempotencyCoordinator(idempotencyRepository, configConfig)
	idempotencyCleanupService := service.ProvideIdempotencyCleanupService(idempotencyRepository, configConfig)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, imageWorkbenchHandler, idempotencyCoordinator, idempotencyCleanupService)
