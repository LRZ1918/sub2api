export default {
  ...
  auth: {
    ...
    loginAgreementRequiredForLogin: '请先阅读并同意最新条款后再登录或使用快捷登录。',
    loginAgreementRequiredForRegister: '请先阅读并同意最新条款后再注册或使用快捷登录。',
    emailLabel: '邮箱',
  ...
  channelStatus: {
    ...
    allProviders: '全部供应商',
    disabledTitle: '渠道状态入口未启用',
    disabledDesc: '管理员还没有在系统设置中开放渠道状态展示。开启并配置渠道监控后，这里会显示渠道可用率、延迟和近期状态。',
    loadError: '加载渠道状态失败',
  ...
  availableChannels: {
    ...
    empty: '暂无可用渠道',
    emptyDesc: '管理员尚未创建可展示的渠道、可访问分组或模型定价。配置完成后，这里会显示你能调用的渠道、模型和价格。',
    disabledTitle: '可用渠道入口未启用',
    disabledDesc: '管理员还没有在系统设置中开放可用渠道展示。开启后，这里会显示你能访问的渠道、模型和定价。',
    noModels: '未配置模型',
    noPricing: '未配置定价',
    exclusive: '专属',
    public: '公开',
  ...
  modelSquare: {
    ...
    billingNotice: '仅展示当前有可调用分组的模型；实际扣费还可能受用户专属倍率、渠道映射、订阅配额和按次/图片计费影响，以账单为准。',
    disabledTitle: '模型广场暂未启用',
    disabledDesc: '管理员还没有开放可用渠道与模型展示。开启后，这里会显示你可调用的模型、基础价格和可访问分组。',
    empty: '暂无可显示的模型',
    emptyDesc: '管理员尚未创建可用渠道和模型定价。配置完成后，这里会显示你可调用的模型、基础价格和可访问分组倍率。',
    available: '可用',
    inputPrice: '输入',
    outputPrice: '输出',
    ...
    availableGroupsCount: '可调用分组倍率 · {count} 个'
  },

  affiliate: {
    title: '邀请返利',
    description: '邀请新用户注册，并将返利额度转入账户余额',
    disabledTitle: '邀请返利暂未启用',
    disabledDesc: '管理员还没有开放邀请返利功能。开启后，你可以在这里查看邀请码、返利比例和转余额记录。',
    unavailableTitle: '邀请返利数据暂时不可用',
    unavailableDesc: '当前无法加载邀请返利配置或记录，请稍后刷新；如果持续出现，请联系管理员检查返利设置。',
    yourCode: '我的邀请码',
    inviteLink: '邀请链接',
    copyCode: '复制邀请码',
    copyLink: '复制链接',
  ...
  admin: {
    ...
    launchReadiness: {
      ...
      actionQueue: {
        title: '待处理队列',
        description: '按阻断优先级列出接下来要清理的配置项。'
      },
      status: {
        pass: '通过',
        warn: '待收口',
    ...
    channels: {
      ...
      referencePreset: {
        import: '导入参考站渠道',
        createSuccess: '参考站渠道预设已创建',
        alreadyExists: '参考站渠道预设已存在，请编辑现有渠道或删除后重新导入。',
        noEligibleGroups: '没有找到可用于参考渠道的活跃 OpenAI 分组，请先导入参考套餐或创建 OpenAI 分组。',
        createError: '创建参考站渠道预设失败'
      },
      columns: {
        name: '名称',
        description: '描述',
    ...
    settings: {
      ...
      userPortal: {
        title: '用户端功能总览',
        description: '集中预览普通用户侧边栏入口，并快速启用增强完整版。',
        applyEnhancedPreset: '启用增强完整版预览',
        menuPreview: '用户端菜单预览',
        ...
        channelStatusDependency: '渠道状态：依赖渠道监控模板和监控任务',
        affiliateDependency: '邀请返利：依赖返利比例和邀请规则',
        customPageDependency: '自定义页面：需要菜单 URL',
        enhancedPresetApplied: '已启用增强完整版预览配置，请保存设置后生效。',
        statusEnabled: '已开启',
        statusDisabled: '未开启',
        statusOptional: '可选',
        statusConfigured: '已配置',
        statusNotConfigured: '未配置',
        statusNeedsSmtp: 'SMTP 未配置',
        statusNeedsRebateRate: '返利比例未配置',
        customPageFallback: '自定义页面',
        featureControls: '用户端功能开放',
        featureControlsHint: '这些开关会直接决定普通用户端入口是否显示，并会随保存写入公开设置。',
        registrationEntry: '开放用户注册',
        registrationEntryHint: '控制登录页注册入口和邮箱密码注册接口。',
        nativePaymentEntry: '开放原生充值/订阅',
        nativePaymentEntryHint: '控制内置支付、套餐和订单入口；需要支付服务商和套餐配置配合。',
        ...
        channelStatusEntryHint: '控制普通用户是否能查看渠道健康检查和延迟状态。',
        affiliateEntry: '开放邀请返利',
        affiliateEntryHint: '控制普通用户邀请返利入口，以及注册和充值时的返利逻辑。'
      },
      features: {
        channelMonitor: {
          title: '渠道监控',
  ...
  purchase: {
    ...
    refreshed: '购买信息已刷新',
    myOrders: '我的订单',
    ordersPanelTitle: '我的订单',
    ordersPanelSubtitle: '查看最近的充值和订阅订单',
    ordersPanelEmpty: '暂无订单',
    ordersPanelOpenFull: '查看完整订单页',
    rechargeModeTitle: '按量付费模式',
    rechargeModeSubtitle: '充值即用，按量扣费',
    rechargeRate: '1 元 = 1 美元余额',
    paypalRate: 'PayPal：充值 1 美元 = 5 美元余额',
    paypalLabel: 'PayPal',
    alipayPendingConfig: '待配置',
    paypalNotSupported: '未接入',
    universalBalance: '余额全站通用，按实际调用消耗',
    rechargeAmount: '充值金额',
    customAmount: '自定义金额',
    flowTitle: '购买流程',
    flowSelectPlan: '选择套餐',
    ...
    flowGetCode: '获取激活码',
    flowActivate: '激活使用',
    rechargeNow: '立即充值 ¥{amount}',
    backToPlans: '返回套餐页面',
    confirmOrder: '确认订单',
    payableAmount: '应付金额',
    buyNow: '立即购买',
    paymentMethodsNotConfiguredTitle: '支付方式未配置',
    paymentMethodsNotConfiguredDesc: '当前站点还没有启用可用支付方式。请管理员在系统设置中开启支付，并在套餐管理里配置官方支付宝服务商和可售套餐。',
    paymentActionUnavailable: '请先配置支付方式',
    pendingOrdersBlocked: '您有 {count} 个待支付订单，请先完成或取消后再试（最多 {max} 个）。',
    pendingOrdersTooMany: '待支付订单过多',
  ...
  customPage: {
    ...
    openInNewTab: '新窗口打开',
    toc: '目录',
    markdownNotFound: '页面内容不存在或尚未发布。',
    markdownLoadFailed: '页面加载失败，请稍后重试。',
    copyCode: '复制',
    copied: '已复制',
    copyFailed: '复制失败',
    notFoundTitle: '页面不存在',
  ...
  payment: {
    ...
    admin: {
      ...
      productName: '产品标签',
      productNameHint: '每行一个标签，会显示在用户端套餐卡片上，例如 /v1/messages、gpt-5.4。',
      productNamePlaceholder: '/v1/messages\ngpt-5.4',
      importReferencePlans: '导入参考站套餐',
      importingReferencePlans: '正在导入...',
      referencePlansImported: '已导入 {count} 个参考站套餐',
      providerManagement: '服务商管理',
      providerManagementDesc: '管理支付服务商实例',
