export default {
  ...
  auth: {
    ...
    loginAgreementRequiredForLogin:
      'Please read and accept the latest terms before signing in or using quick sign-in.',
    loginAgreementRequiredForRegister:
      'Please read and accept the latest terms before registering or using quick sign-in.',
    emailLabel: 'Email',
  ...
  channelStatus: {
    ...
    disabledTitle: 'Channel status is not enabled',
    disabledDesc:
      'The administrator has not enabled the channel status view yet. Once enabled and configured, this page will show availability, latency, and recent status.',
  ...
  availableChannels: {
    ...
    emptyDesc:
      'The administrator has not created visible channels, accessible groups, or model pricing yet. Once configured, this page will show the channels, models, and prices you can use.',
    disabledTitle: 'Available channels are not enabled',
    disabledDesc:
      'The administrator has not enabled the available channels view yet. Once enabled, this page will show the channels, models, and pricing you can access.',
  ...
  modelSquare: {
    title: 'Model Square',
    description: 'Browse available models and baseline pricing',
    ...
    billingNotice:
      'Only models with callable groups are shown. Final billing can still be affected by user-specific rates, channel mappings, subscription quotas, per-request pricing, and image pricing.',
    disabledTitle: 'Model Square is not enabled',
    disabledDesc:
      'The administrator has not enabled available channel and model display yet. Once enabled, this page will show callable models, baseline prices, and accessible groups.',
    empty: 'No models to display',
    emptyDesc:
      'The administrator has not configured available channels and model pricing yet. Once configured, this page will show callable models, baseline prices, and accessible group rates.',
    available: 'Available',
    inputPrice: 'Input',
    outputPrice: 'Output',
    cacheReadPrice: 'Cache Read',
    cacheWritePrice: 'Cache Write',
    unitPerMillionTokens: '$/M tokens',
    availableGroupsCount: 'Callable group rates · {count}'
  },

  affiliate: {
    title: 'Affiliate Rebates',
    description: 'Invite new users and convert your rebate quota into account balance',
    disabledTitle: 'Affiliate rebates are not enabled',
    disabledDesc:
      'The administrator has not enabled affiliate rebates yet. Once enabled, you can view your invite code, rebate rate, and balance transfers here.',
    unavailableTitle: 'Affiliate rebate data is unavailable',
    unavailableDesc:
      'Affiliate settings or records could not be loaded right now. Refresh later, or ask an administrator to check the rebate configuration.',
  ...
  admin: {
    ...
    launchReadiness: {
      ...
      actionQueue: {
        title: 'Action Queue',
        description: 'Lists the next configuration items to clear in blocking-priority order.'
      },
      status: {
        pass: 'Passed',
        warn: 'Needs Review',
    ...
    channels: {
      ...
      referencePreset: {
        import: 'Import Reference Channel',
        createSuccess: 'Reference channel preset created',
        alreadyExists: 'Reference channel preset already exists. Edit the existing channel or delete it before importing again.',
        noEligibleGroups: 'No eligible active OpenAI groups found. Import reference plans or create an OpenAI group first.',
        createError: 'Failed to create reference channel preset'
      },
      columns: {
        name: 'Name',
        description: 'Description',
    ...
    settings: {
      ...
      userPortal: {
        ...
        description: 'Preview the regular user sidebar and quickly enable the enhanced portal.',
        applyEnhancedPreset: 'Enable Enhanced Preview',
        menuPreview: 'User Menu Preview',
        ...
        channelStatusDependency: 'Channel status: requires channel monitor templates and monitor jobs',
        affiliateDependency: 'Affiliate rebate: requires a rebate rate and invitation rules',
        customPageDependency: 'Custom page: requires a menu URL',
        enhancedPresetApplied: 'Enhanced user portal preview has been enabled. Save settings to apply it.',
        statusEnabled: 'Enabled',
        statusDisabled: 'Disabled',
        statusOptional: 'Optional',
        statusConfigured: 'Configured',
        statusNotConfigured: 'Not configured',
        statusNeedsSmtp: 'SMTP not configured',
        statusNeedsRebateRate: 'Rebate rate not configured',
        customPageFallback: 'Custom Page',
        featureControls: 'User portal feature controls',
        featureControlsHint: 'These switches directly control which user portal entries are visible and are saved into public settings.',
        registrationEntry: 'Open user registration',
        registrationEntryHint: 'Controls the login-page registration entry and email/password registration API.',
        nativePaymentEntry: 'Open native recharge/subscription',
        nativePaymentEntryHint: 'Controls built-in payment, plans and order entries; requires payment providers and saleable plans.',
        ...
        channelStatusEntryHint: 'Controls whether users can see health-check and latency status.',
        affiliateEntry: 'Open affiliate rebate',
        affiliateEntryHint: 'Controls the affiliate entry plus registration and recharge rebate behavior.'
      },
      features: {
        channelMonitor: {
          title: 'Channel Monitor',
  ...
  purchase: {
    ...
    description: 'Recharge balance or purchase a subscription plan',
    ...
    myOrders: 'My Orders',
    ordersPanelTitle: 'My Orders',
    ordersPanelSubtitle: 'View recent recharge and subscription orders',
    ordersPanelEmpty: 'No orders yet',
    ordersPanelOpenFull: 'Open full orders page',
    rechargeModeTitle: 'Pay-as-you-go',
    rechargeModeSubtitle: 'Recharge and use immediately, billed by actual usage',
    rechargeRate: '1 CNY = 1 USD balance',
    paypalRate: 'PayPal: recharge 1 USD = 5 USD balance',
    paypalLabel: 'PayPal',
    alipayPendingConfig: 'Pending configuration',
    paypalNotSupported: 'Not integrated',
    universalBalance: 'Balance is shared across the site and consumed by actual usage',
    rechargeAmount: 'Recharge Amount',
    customAmount: 'Custom Amount',
    flowTitle: 'Purchase Flow',
    flowSelectPlan: 'Choose Plan',
    flowPay: 'Pay',
    flowGetCode: 'Get Activation Code',
    ...
    buyNow: 'Buy Now',
    paymentMethodsNotConfiguredTitle: 'Payment methods not configured',
    paymentMethodsNotConfiguredDesc:
      'No available payment method is enabled for this site yet. Administrators need to enable payment in system settings and configure the official Alipay provider and saleable plans in plan management.',
    paymentActionUnavailable: 'Configure payment methods first',
    pendingOrdersBlocked: 'You have {count} pending orders. Please complete or cancel them before trying again (maximum {max}).',
    pendingOrdersTooMany: 'Too many pending orders',
  ...
  customPage: {
    ...
    markdownNotFound: 'Page content is missing or has not been published.',
    markdownLoadFailed: 'Failed to load page. Please try again later.',
    copyCode: 'Copy',
    copied: 'Copied',
    copyFailed: 'Copy failed',
  ...
  payment: {
    ...
    planCard: {
      ...
      packageRate: 'Plan Converted Rate',
      concurrency: 'Concurrency',
      dailyLimit: 'Daily',
      weeklyLimit: 'Weekly',
    ...
    admin: {
      ...
      productName: 'Product Tags',
      productNameHint: 'One tag per line. These appear on user-facing plan cards, for example /v1/messages and gpt-5.4.',
      productNamePlaceholder: '/v1/messages\ngpt-5.4',
      importReferencePlans: 'Import Reference Plans',
      importingReferencePlans: 'Importing...',
      referencePlansImported: 'Imported {count} reference plans',
      providerManagement: 'Provider Management',
      providerManagementDesc: 'Manage payment provider instances',
